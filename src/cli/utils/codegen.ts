...
export class CodeGenerator {
  ...
  async generateSchema(
    ...
    logger.info(`🔧 Generating schema: ${config.name}`);
 ...
 */`);
    ...
    logger.success(`✅ Schema generated: ${outputPath}`);
  }
  ...
  async addFieldToSchema(
    ...
    logger.info(`🔧 Adding field '${field.name}' to ${schemaFile}`);
    ...
    await sourceFile.save();
    logger.success(`✅ Field '${field.name}' added to schema`);
  }
  ...
  async generateFormComponent(
    ...
    logger.info(`🔧 Generating form component for ${schemaName}`);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="text-sm text-gray-500">
        Form generated by Conform CLI - customize as needed
      </div>
